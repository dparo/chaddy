...
#define CODE_IF(r, cond, ...) HTML_ELEM(r, (cond) ? "code" : NULL, __VA_ARGS__)
#define B_IF(r, cond, ...) HTML_ELEM(r, (cond) ? "b" : NULL, __VA_ARGS__)
#define BUTTON_IF(r, cond, ...) HTML_ELEM(r, (cond) ? "button" : NULL, __VA_ARGS__)
...
#define CODE(r, ...) CODE_IF(r, true, __VA_ARGS__)
#define B(r, ...) B_IF(r, true, __VA_ARGS__)
#define BUTTON(r, ...) BUTTON_IF(r, true, __VA_ARGS__)
